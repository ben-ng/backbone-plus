...
/**
* Why are we using browser-request here? For whatever reason,
* the built-in jQuery.ajax function that Backbone uses doesn't
* play well with Phonegap. By using ourr own ajax function, we
* get reliable requests on desktop browsers and mobile apps.
*/
